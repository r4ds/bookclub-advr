...
## Though the values bound to names seem the same, the values in memory are distinct
...
## The environment within functions also copies values
...
## We can measure memory for dynamically created values using `bench::mark()`
