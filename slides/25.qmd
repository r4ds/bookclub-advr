...
## Using C++ is easier and flexible, while Rust requires {rextendr}
...
```{r}
Rcpp::cppFunction("
IntegerVector signC(NumericVector x) {
  int n = x.size();
  IntegerVector out(n);
...
## Comparing inline function performance from R between R, C++ and Rust can be misleading!
