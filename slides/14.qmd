...
-   *sum* and *add* are methods of the Accumulator object.
-   Can't use *sum* and *add* outside these classes
...
## R6 objects are moified in place

-   The *add* method update the object's sum field  in the environment
