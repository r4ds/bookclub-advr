...
3. How to create a custom S3 class?
4. How to create S3 generic functions
...
##  The function `summary` is a generic S3 function
...
-   The goal is to summarize characters, factors, numeric, etc. objects
-   The output should always be a length one character vector
