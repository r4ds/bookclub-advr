...
## Online resources can provide existing solutions or new coding approaches

1.  Package documentation
2.  Search engine e.g. Google
3.  Github issues for a package
4.  CRAN task views (http://cran.rstudio.com/web/views/)
5.  Reverse dependencies of Rcpp (https://cran.r-project.org/web/packages/Rcpp/)

## Online communities also provide learning opportunities and idea sharing
